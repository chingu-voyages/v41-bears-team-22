    ...
    return (
        <div className='auth-wrapper'>
            <Row className='auth-inner m-0'>
                ...
                <Col className="d-flex align-items-center register p-2 p-lg-5" lg='4' sm='12'>
                    <Col className="px-xl-2 mx-auto auth-bg" sm='8' md='6' lg='12'>
                        <CardTitle tag="h2" className="font-weight-bold">
                            Welcome to Fast Track!
                        </CardTitle>
                        ...
                        <Form className='auth-login-form mt-2' onSubmit={handleRegister}>
                            ...
                            <FormGroup>
                                <Label className="conf" for="passwordConf">Password: </Label>
                                <Input
                                    type="password"
                                    value={user.passwordConf}
                                    id="passwordConf"
...
>>>>>>> 6df5e01e97c479f4e0fb4392f0de7948016e8e8d
